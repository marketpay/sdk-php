...
------------- | ------------- | -------------
[**transfersGet**](TransfersApi.md#transfersGet) | **GET** /v2.1/Transfers/{TransferId} | 
[**transfersGetList**](TransfersApi.md#transfersGetList) | **GET** /v2.1/Transfers | 
[**transfersPost**](TransfersApi.md#transfersPost) | **POST** /v2.1/Transfers | 
...
[**\MarketPay\Model\TransferResponseResponseList**](../Model/TransferResponseResponseList.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\MarketPay\Model\TransferPost**](../Model/TransferPost.md)|  | [optional]
