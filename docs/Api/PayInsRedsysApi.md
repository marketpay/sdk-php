...
[**payInsRedsysRedsysWebhookPreauthorizationSoap**](PayInsRedsysApi.md#payInsRedsysRedsysWebhookPreauthorizationSoap) | **POST** /v2.01/PayInsRedsys/webhook/preauthorizesoap/{IntentId} | 
...
# **payInsRedsysRedsysWebhookPayment**
> payInsRedsysRedsysWebhookPayment($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature)
...
$api_instance = new MarketPay\Api\PayInsRedsysApi();
$intent_id = 789; // int | 
$ds_signature_version = "ds_signature_version_example"; // string | 
$ds_merchant_parameters = "ds_merchant_parameters_example"; // string | 
$ds_signature = "ds_signature_example"; // string | 

try {
    $api_instance->payInsRedsysRedsysWebhookPayment($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature);
} catch (Exception $e) {
    echo 'Exception when calling PayInsRedsysApi->payInsRedsysRedsysWebhookPayment: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **payInsRedsysRedsysWebhookPaymentSoap**
> payInsRedsysRedsysWebhookPaymentSoap($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature)
...
try {
    $api_instance->payInsRedsysRedsysWebhookPaymentSoap($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature);
} catch (Exception $e) {
    echo 'Exception when calling PayInsRedsysApi->payInsRedsysRedsysWebhookPaymentSoap: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **payInsRedsysRedsysWebhookPreauthorization**
> payInsRedsysRedsysWebhookPreauthorization($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature)
...
try {
    $api_instance->payInsRedsysRedsysWebhookPreauthorization($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature);
} catch (Exception $e) {
    echo 'Exception when calling PayInsRedsysApi->payInsRedsysRedsysWebhookPreauthorization: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
# **payInsRedsysRedsysWebhookPreauthorizationSoap**
> payInsRedsysRedsysWebhookPreauthorizationSoap($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature)
...
try {
    $api_instance->payInsRedsysRedsysWebhookPreauthorizationSoap($intent_id, $ds_signature_version, $ds_merchant_parameters, $ds_signature);
} catch (Exception $e) {
    echo 'Exception when calling PayInsRedsysApi->payInsRedsysRedsysWebhookPreauthorizationSoap: ', $e->getMessage(), PHP_EOL;
}
?>
```
