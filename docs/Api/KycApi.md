...
# **kycPostDocument**
> \MarketPay\Model\KycFileUploadResponse kycPostDocument($document_type, $file, $user_id)
...
# **kycPutDocument**
> \MarketPay\Model\KycFileUploadResponse kycPutDocument($document_type, $file, $user_id)
