...
class PayInsRedsysApi
{
    ...
    protected function payInsRedsysRedsysGetPaymentRequest($pay_in_id)
    {
        ...
        $resourcePath = '/v2.1/PayInsRedsys/payments/{PayInId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    protected function payInsRedsysRedsysGetPreauthorizationRequest($preauthorization_id)
    {
        ...
        $resourcePath = '/v2.1/PayInsRedsys/preauthorizations/{PreauthorizationId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation payInsRedsysRedsysGetRefund
     *
     ...
     */
    public function payInsRedsysRedsysGetRefund($refund_id)
    {
        list($response) = $this->payInsRedsysRedsysGetRefundWithHttpInfo($refund_id);
        return $response;
    }

    /**
     * Operation payInsRedsysRedsysGetRefundWithHttpInfo
     *
     ...
     */
    public function payInsRedsysRedsysGetRefundWithHttpInfo($refund_id)
    {
        $returnType = '\MarketPay\Model\RedsysRefundResponse';
        $request = $this->payInsRedsysRedsysGetRefundRequest($refund_id);
    ...
    /**
     * Operation payInsRedsysRedsysGetRefundAsync
     *
     *
     *
     * @param  int $refund_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysGetRefundAsync($refund_id)
    {
        return $this->payInsRedsysRedsysGetRefundAsyncWithHttpInfo($refund_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation payInsRedsysRedsysGetRefundAsyncWithHttpInfo
     *
     *
     *
     * @param  int $refund_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysGetRefundAsyncWithHttpInfo($refund_id)
    {
        $returnType = '\MarketPay\Model\RedsysRefundResponse';
        $request = $this->payInsRedsysRedsysGetRefundRequest($refund_id);
    ...
    /**
     * Create request for operation 'payInsRedsysRedsysGetRefund'
     *
     * @param  int $refund_id (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysGetRefundRequest($refund_id)
    {
        // verify the required parameter 'refund_id' is set
        if ($refund_id === null || (is_array($refund_id) && count($refund_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $refund_id when calling payInsRedsysRedsysGetRefund'
            );
        }

        $resourcePath = '/v2.1/PayInsRedsys/refunds/{RefundId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \MarketPay\Model\RedsysPayByWebPost $body body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\RedsysPayByWebResponse
     */
    public function payInsRedsysRedsysPostPaymentByWeb($x_webhook = null, $body = null)
    {
        list($response) = $this->payInsRedsysRedsysPostPaymentByWebWithHttpInfo($x_webhook, $body);
        return $response;
    }
     ...
     * @param  \MarketPay\Model\RedsysPayByWebPost $body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MarketPay\Model\RedsysPayByWebResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payInsRedsysRedsysPostPaymentByWebWithHttpInfo($x_webhook = null, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPayByWebResponse';
        $request = $this->payInsRedsysRedsysPostPaymentByWebRequest($x_webhook, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPaymentByWebAsync($x_webhook = null, $body = null)
    {
        return $this->payInsRedsysRedsysPostPaymentByWebAsyncWithHttpInfo($x_webhook, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPaymentByWebAsyncWithHttpInfo($x_webhook = null, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPayByWebResponse';
        $request = $this->payInsRedsysRedsysPostPaymentByWebRequest($x_webhook, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysPostPaymentByWebRequest($x_webhook = null, $body = null)
    {

        $resourcePath = '/v2.1/PayInsRedsys/payments/web';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  \MarketPay\Model\RedsysPreauthorizeByWebPost $body body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\RedsysPreauthorizeByWebResponse
     */
    public function payInsRedsysRedsysPostPreauthorizationByWeb($body = null)
    {
        list($response) = $this->payInsRedsysRedsysPostPreauthorizationByWebWithHttpInfo($body);
        return $response;
    }
     ...
     *
     * @param  \MarketPay\Model\RedsysPreauthorizeByWebPost $body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MarketPay\Model\RedsysPreauthorizeByWebResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payInsRedsysRedsysPostPreauthorizationByWebWithHttpInfo($body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPreauthorizeByWebResponse';
        $request = $this->payInsRedsysRedsysPostPreauthorizationByWebRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPreauthorizationByWebAsync($body = null)
    {
        return $this->payInsRedsysRedsysPostPreauthorizationByWebAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPreauthorizationByWebAsyncWithHttpInfo($body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPreauthorizeByWebResponse';
        $request = $this->payInsRedsysRedsysPostPreauthorizationByWebRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysPostPreauthorizationByWebRequest($body = null)
    {

        $resourcePath = '/v2.1/PayInsRedsys/preauthorizations/web';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $preauthorization_id preauthorization_id (required)
     * @param  \MarketPay\Model\RedsysPreauthorizationCancellationPost $body body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\RedsysPreauthorizationCancellationResponse
     */
    public function payInsRedsysRedsysPostPreauthorizationCancellation($preauthorization_id, $body = null)
    {
        list($response) = $this->payInsRedsysRedsysPostPreauthorizationCancellationWithHttpInfo($preauthorization_id, $body);
        return $response;
    }
     ...
     *
     * @param  int $preauthorization_id (required)
     * @param  \MarketPay\Model\RedsysPreauthorizationCancellationPost $body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function payInsRedsysRedsysPostPreauthorizationCancellationWithHttpInfo($preauthorization_id, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPreauthorizationCancellationResponse';
        $request = $this->payInsRedsysRedsysPostPreauthorizationCancellationRequest($preauthorization_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPreauthorizationCancellationAsync($preauthorization_id, $body = null)
    {
        return $this->payInsRedsysRedsysPostPreauthorizationCancellationAsyncWithHttpInfo($preauthorization_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPreauthorizationCancellationAsyncWithHttpInfo($preauthorization_id, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPreauthorizationCancellationResponse';
        $request = $this->payInsRedsysRedsysPostPreauthorizationCancellationRequest($preauthorization_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysPostPreauthorizationCancellationRequest($preauthorization_id, $body = null)
    {
        // verify the required parameter 'preauthorization_id' is set
        if ($preauthorization_id === null || (is_array($preauthorization_id) && count($preauthorization_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/v2.1/PayInsRedsys/preauthorizations/{PreauthorizationId}/cancellation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  int $preauthorization_id preauthorization_id (required)
     * @param  \MarketPay\Model\RedsysPreauthorizationConfirmationPost $body body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\RedsysPreauthorizationConfirmationResponse
     */
    public function payInsRedsysRedsysPostPreauthorizationConfirmation($preauthorization_id, $body = null)
    {
        list($response) = $this->payInsRedsysRedsysPostPreauthorizationConfirmationWithHttpInfo($preauthorization_id, $body);
        return $response;
    }
     ...
     *
     * @param  int $preauthorization_id (required)
     * @param  \MarketPay\Model\RedsysPreauthorizationConfirmationPost $body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function payInsRedsysRedsysPostPreauthorizationConfirmationWithHttpInfo($preauthorization_id, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPreauthorizationConfirmationResponse';
        $request = $this->payInsRedsysRedsysPostPreauthorizationConfirmationRequest($preauthorization_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPreauthorizationConfirmationAsync($preauthorization_id, $body = null)
    {
        return $this->payInsRedsysRedsysPostPreauthorizationConfirmationAsyncWithHttpInfo($preauthorization_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostPreauthorizationConfirmationAsyncWithHttpInfo($preauthorization_id, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysPreauthorizationConfirmationResponse';
        $request = $this->payInsRedsysRedsysPostPreauthorizationConfirmationRequest($preauthorization_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysPostPreauthorizationConfirmationRequest($preauthorization_id, $body = null)
    {
        // verify the required parameter 'preauthorization_id' is set
        if ($preauthorization_id === null || (is_array($preauthorization_id) && count($preauthorization_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/v2.1/PayInsRedsys/preauthorizations/{PreauthorizationId}/confirmation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $pay_in_id pay_in_id (required)
     * @param  string $x_webhook x_webhook (optional)
     * @param  \MarketPay\Model\RedsysRefundPost $body body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\RedsysRefundResponse
     */
    public function payInsRedsysRedsysPostRefund($pay_in_id, $x_webhook = null, $body = null)
    {
        list($response) = $this->payInsRedsysRedsysPostRefundWithHttpInfo($pay_in_id, $x_webhook, $body);
        return $response;
    }
     ...
     * @param  int $pay_in_id (required)
     * @param  string $x_webhook (optional)
     * @param  \MarketPay\Model\RedsysRefundPost $body (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MarketPay\Model\RedsysRefundResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payInsRedsysRedsysPostRefundWithHttpInfo($pay_in_id, $x_webhook = null, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysRefundResponse';
        $request = $this->payInsRedsysRedsysPostRefundRequest($pay_in_id, $x_webhook, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostRefundAsync($pay_in_id, $x_webhook = null, $body = null)
    {
        return $this->payInsRedsysRedsysPostRefundAsyncWithHttpInfo($pay_in_id, $x_webhook, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostRefundAsyncWithHttpInfo($pay_in_id, $x_webhook = null, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysRefundResponse';
        $request = $this->payInsRedsysRedsysPostRefundRequest($pay_in_id, $x_webhook, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysPostRefundRequest($pay_in_id, $x_webhook = null, $body = null)
    {
        // verify the required parameter 'pay_in_id' is set
        if ($pay_in_id === null || (is_array($pay_in_id) && count($pay_in_id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        $resourcePath = '/v2.1/PayInsRedsys/payments/{PayInId}/refunds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
