...
class PayInsRedsysApi
{
     ...
     */
    public function payInsRedsysRedsysPostRefund($pay_in_id, $body = null)
    {
        list($response) = $this->payInsRedsysRedsysPostRefundWithHttpInfo($pay_in_id, $body);
        return $response;
    }
     ...
     */
    public function payInsRedsysRedsysPostRefundWithHttpInfo($pay_in_id, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysRefundResponse';
        $request = $this->payInsRedsysRedsysPostRefundRequest($pay_in_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostRefundAsync($pay_in_id, $body = null)
    {
        return $this->payInsRedsysRedsysPostRefundAsyncWithHttpInfo($pay_in_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsRedsysRedsysPostRefundAsyncWithHttpInfo($pay_in_id, $body = null)
    {
        $returnType = '\MarketPay\Model\RedsysRefundResponse';
        $request = $this->payInsRedsysRedsysPostRefundRequest($pay_in_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsRedsysRedsysPostRefundRequest($pay_in_id, $body = null)
    {
        // verify the required parameter 'pay_in_id' is set
        if ($pay_in_id === null || (is_array($pay_in_id) && count($pay_in_id) === 0)) {
            throw new \InvalidArgumentException(
