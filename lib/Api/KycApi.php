...
class KycApi
{
    ...
    {
        $returnType = '\Swagger\Client\Model\KycUserValidationLevelLegalResponse';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ResponseListKycUserValidationLevelNaturalResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ResponseListKycUserValidationLevelNaturalResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\ResponseListKycUserValidationLevelNaturalResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ResponseListKycUserValidationLevelNaturalResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\Swagger\Client\Model\KycUserValidationLevelNaturalResponse';
    ...
    {
        $returnType = '\Swagger\Client\Model\KycValidationUserStatusResponse';
    ...
    {
        $returnType = '\Swagger\Client\Model\KycFileUploadResponse';
     ...
     *
     * @param  int $user_id user_id (required)
     * @param  \Swagger\Client\Model\KycIdentificationRequest $validation_request validation_request (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        $returnType = '\Swagger\Client\Model\KycValidationRequestResponse';
