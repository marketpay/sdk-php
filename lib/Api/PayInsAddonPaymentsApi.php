...
class PayInsAddonPaymentsApi
{
     ...
     *
     * @param  \MarketPay\Model\AddonPaymentsPayDirectPost $addon_payments_pay_in addon_payments_pay_in (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\AddonPaymentsPayDirectResponse
     */
    public function payInsAddonPaymentsAddonPaymentsPostPaymentDirect($addon_payments_pay_in = null)
    {
        list($response) = $this->payInsAddonPaymentsAddonPaymentsPostPaymentDirectWithHttpInfo($addon_payments_pay_in);
        return $response;
    }
     ...
     *
     * @param  \MarketPay\Model\AddonPaymentsPayDirectPost $addon_payments_pay_in (optional)
     *
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MarketPay\Model\AddonPaymentsPayDirectResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payInsAddonPaymentsAddonPaymentsPostPaymentDirectWithHttpInfo($addon_payments_pay_in = null)
    {
        $returnType = '\MarketPay\Model\AddonPaymentsPayDirectResponse';
        $request = $this->payInsAddonPaymentsAddonPaymentsPostPaymentDirectRequest($addon_payments_pay_in);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsAddonPaymentsAddonPaymentsPostPaymentDirectAsync($addon_payments_pay_in = null)
    {
        return $this->payInsAddonPaymentsAddonPaymentsPostPaymentDirectAsyncWithHttpInfo($addon_payments_pay_in)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsAddonPaymentsAddonPaymentsPostPaymentDirectAsyncWithHttpInfo($addon_payments_pay_in = null)
    {
        $returnType = '\MarketPay\Model\AddonPaymentsPayDirectResponse';
        $request = $this->payInsAddonPaymentsAddonPaymentsPostPaymentDirectRequest($addon_payments_pay_in);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsAddonPaymentsAddonPaymentsPostPaymentDirectRequest($addon_payments_pay_in = null)
    {
