...
class PayInsPluginApi
{
     ...
     * @return \MarketPay\Model\PluginPayInsResponse
     */
    public function payInsPluginPluginClientPayInPost($plugin_pay_in = null)
    {
        list($response) = $this->payInsPluginPluginClientPayInPostWithHttpInfo($plugin_pay_in);
        return $response;
    }
     ...
     * @return array of \MarketPay\Model\PluginPayInsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payInsPluginPluginClientPayInPostWithHttpInfo($plugin_pay_in = null)
    {
        $returnType = '\MarketPay\Model\PluginPayInsResponse';
        $request = $this->payInsPluginPluginClientPayInPostRequest($plugin_pay_in);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsPluginPluginClientPayInPostAsync($plugin_pay_in = null)
    {
        return $this->payInsPluginPluginClientPayInPostAsyncWithHttpInfo($plugin_pay_in)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsPluginPluginClientPayInPostAsyncWithHttpInfo($plugin_pay_in = null)
    {
        $returnType = '\MarketPay\Model\PluginPayInsResponse';
        $request = $this->payInsPluginPluginClientPayInPostRequest($plugin_pay_in);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsPluginPluginClientPayInPostRequest($plugin_pay_in = null)
    {
