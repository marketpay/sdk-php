...
class MeApi
{
     ...
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MarketPay\Model\ResponseListTransferMethodsResponse
     */
     ...
     * @throws \MarketPay\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MarketPay\Model\ResponseListTransferMethodsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function meGetPayInsWithHttpInfo($page = null, $per_page = null, $currency = null)
    {
        $returnType = '\MarketPay\Model\ResponseListTransferMethodsResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MarketPay\Model\ResponseListTransferMethodsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
