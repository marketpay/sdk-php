...
class MeApi
{
     ...
     * @return \Swagger\Client\Model\WalletClientInstrumentResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\WalletClientInstrumentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function meGetWithHttpInfo($currency)
    {
        $returnType = '\Swagger\Client\Model\WalletClientInstrumentResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\WalletClientInstrumentResponse',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ResponseListWalletClientInstrumentResponse
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ResponseListWalletClientInstrumentResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function meGetListWithHttpInfo($page = null, $per_page = null)
    {
        $returnType = '\Swagger\Client\Model\ResponseListWalletClientInstrumentResponse';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ResponseListWalletClientInstrumentResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
