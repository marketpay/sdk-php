...
class PayInsClientApi
{
     ...
     */
    public function payInsClientPluginClientConfirmPayIn($intent_id, $body = null)
    {
        list($response) = $this->payInsClientPluginClientConfirmPayInWithHttpInfo($intent_id, $body);
        return $response;
    }
     ...
     */
    public function payInsClientPluginClientConfirmPayInWithHttpInfo($intent_id, $body = null)
    {
        $returnType = '\MarketPay\Model\PluginPayInsResponse';
        $request = $this->payInsClientPluginClientConfirmPayInRequest($intent_id, $body);
     ...
     */
    public function payInsClientPluginClientConfirmPayInAsync($intent_id, $body = null)
    {
        return $this->payInsClientPluginClientConfirmPayInAsyncWithHttpInfo($intent_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsClientPluginClientConfirmPayInAsyncWithHttpInfo($intent_id, $body = null)
    {
        $returnType = '\MarketPay\Model\PluginPayInsResponse';
        $request = $this->payInsClientPluginClientConfirmPayInRequest($intent_id, $body);
     ...
     */
    protected function payInsClientPluginClientConfirmPayInRequest($intent_id, $body = null)
    {
        // verify the required parameter 'intent_id' is set
        if ($intent_id === null || (is_array($intent_id) && count($intent_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $intent_id when calling payInsClientPluginClientConfirmPayIn'
            );
        }
     ...
     * @return \MarketPay\Model\PluginPayInsResponse
     */
    public function payInsClientPluginClientPayInCreatePost($body = null)
    {
        list($response) = $this->payInsClientPluginClientPayInCreatePostWithHttpInfo($body);
        return $response;
    }
     ...
     * @return array of \MarketPay\Model\PluginPayInsResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function payInsClientPluginClientPayInCreatePostWithHttpInfo($body = null)
    {
        $returnType = '\MarketPay\Model\PluginPayInsResponse';
        $request = $this->payInsClientPluginClientPayInCreatePostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsClientPluginClientPayInCreatePostAsync($body = null)
    {
        return $this->payInsClientPluginClientPayInCreatePostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function payInsClientPluginClientPayInCreatePostAsyncWithHttpInfo($body = null)
    {
        $returnType = '\MarketPay\Model\PluginPayInsResponse';
        $request = $this->payInsClientPluginClientPayInCreatePostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function payInsClientPluginClientPayInCreatePostRequest($body = null)
    {
