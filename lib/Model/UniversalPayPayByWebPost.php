...
class UniversalPayPayByWebPost implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['secure_mode']) && !in_array($this->container['secure_mode'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getSecureModeAllowableValues();
        if (!is_null($secure_mode) && !in_array($secure_mode, $allowedValues, true)) {
