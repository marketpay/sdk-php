...
/**
 * UserLegalPost Class Doc Comment
 *
 * @category Class
 * @package  MarketPay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserLegalPost implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserLegalPost';
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getLegalRepresentativeCountryOfResidenceAllowableValues();
        if (!is_null($this->container['legal_representative_country_of_residence']) && !in_array($this->container['legal_representative_country_of_residence'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
        ...
        $allowedValues = $this->getLegalRepresentativeNationalityAllowableValues();
        if (!is_null($this->container['legal_representative_nationality']) && !in_array($this->container['legal_representative_nationality'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
     ...
     *
     * @param \MarketPay\Model\Address $headquarters_address headquarters_address
     *
     * @return $this
     */
     ...
     *
     * @param \MarketPay\Model\Address $legal_representative_address legal_representative_address
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getLegalRepresentativeCountryOfResidenceAllowableValues();
        if (!is_null($legal_representative_country_of_residence) && !in_array($legal_representative_country_of_residence, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'legal_representative_country_of_residence', must be one of '%s'",
                    implode("', '", $allowedValues)
    ...
    {
        $allowedValues = $this->getLegalRepresentativeNationalityAllowableValues();
        if (!is_null($legal_representative_nationality) && !in_array($legal_representative_nationality, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'legal_representative_nationality', must be one of '%s'",
                    implode("', '", $allowedValues)
