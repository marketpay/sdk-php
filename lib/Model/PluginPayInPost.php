...
/**
 * PluginPayInPost Class Doc Comment
 *
 * @category Class
 * @package  MarketPay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PluginPayInPost implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PluginPayInPost';
     ...
     *
     * @param string $credited_wallet_id Whether to save or not the card for future use. SaveCard and CardId are mutually exclusive
     *
     * @return $this
     */
