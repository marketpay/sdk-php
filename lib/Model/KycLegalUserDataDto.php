...
class KycLegalUserDataDto implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \MarketPay\Model\PropertyValidationString $contact_first_name The name of the user
     *
     * @return $this
     */
     ...
     *
     * @param \MarketPay\Model\PropertyValidationString $contact_last_name The last name of the user
     *
     * @return $this
     */
     ...
     * Sets fiscal_address
     *
     * @param \MarketPay\Model\TAddressValidationResult $fiscal_address The address
     *
     * @return $this
     */
     ...
     * Sets country
     *
     * @param \MarketPay\Model\PropertyValidationCountry $country The user’s country of residence. ISO 3166-1 alpha-2 format is expected
     *
     * @return $this
     */
     ...
     *
     * @param \MarketPay\Model\TKycFileDetails $fiscal_id_document Identity card file reference
     *
     * @return $this
     */
