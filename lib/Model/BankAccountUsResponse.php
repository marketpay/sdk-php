 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BankAccountUsResponse implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['deposit_account_type']) && !in_array($this->container['deposit_account_type'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getDepositAccountTypeAllowableValues();
        if (!is_null($deposit_account_type) && !in_array($deposit_account_type, $allowedValues, true)) {
