...
class WalletResponse implements ModelInterface, ArrayAccess
{
    ...
    const CURRENCY_RAS = 'RAS';
    const CURRENCY_TRI = 'TRI';
    const CURRENCY_SIX = 'SIX';
    const CURRENCY_OCT = 'OCT';
    const CURRENCY_EPT = 'EPT';
    const CURRENCY_ESA = 'ESA';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['funds_type']) && !in_array($this->container['funds_type'], $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getFundsTypeAllowableValues();
        if (!is_null($funds_type) && !in_array($funds_type, $allowedValues, true)) {
