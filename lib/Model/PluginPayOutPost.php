...
/**
 * PluginPayOutPost Class Doc Comment
 *
 * @category Class
 * @package  MarketPay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PluginPayOutPost implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PluginPayOutPost';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['debited_wallet_id'] === null) {
            $invalidProperties[] = "'debited_wallet_id' can't be null";
        }
