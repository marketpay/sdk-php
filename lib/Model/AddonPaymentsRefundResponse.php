...
/**
 * AddonPaymentsRefundResponse Class Doc Comment
 *
 * @category Class
 * @package  MarketPay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddonPaymentsRefundResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddonPaymentsRefundResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'provider' => '\MarketPay\Model\RefundAddonPaymentsData',
        'id' => 'string',
        'creation_date' => 'int',
        'tag' => 'string'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['initial_transaction_type']) && !in_array($this->container['initial_transaction_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getInitialTransactionTypeAllowableValues();
        if (!is_null($initial_transaction_type) && !in_array($initial_transaction_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'initial_transaction_type', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     * Gets provider
     *
     * @return \MarketPay\Model\RefundAddonPaymentsData
     */
     ...
     * Sets provider
     *
     * @param \MarketPay\Model\RefundAddonPaymentsData $provider provider
     *
     * @return $this
     */
