...
class PayInBankwireResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'bank_account' => '\MarketPay\Model\BankwirePayInBankAccount',
        'id' => 'string',
        'creation_date' => 'int',
        'tag' => 'string'
    ];
     ...
     * Gets bank_account
     *
     * @return \MarketPay\Model\BankwirePayInBankAccount
     */
     ...
     * Sets bank_account
     *
     * @param \MarketPay\Model\BankwirePayInBankAccount $bank_account bank_account
     *
     * @return $this
     */
