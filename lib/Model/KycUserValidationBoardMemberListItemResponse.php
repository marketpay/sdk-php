...
/**
 * KycUserValidationBoardMemberListItemResponse Class Doc Comment
 *
 * @category Class
 * @package  MarketPay
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KycUserValidationBoardMemberListItemResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KycUserValidationBoardMemberListItemResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'power_of_attorney' => '\MarketPay\Model\KycDocumentDetails',
        'id' => 'string',
        'creation_date' => 'int',
        'tag' => 'string'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['country_of_residence']) && !in_array($this->container['country_of_residence'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
    ...
    {
        $allowedValues = $this->getNationalityAllowableValues();
        if (!is_null($nationality) && !in_array($nationality, $allowedValues, true)) {
    ...
    {
        $allowedValues = $this->getCountryOfResidenceAllowableValues();
        if (!is_null($country_of_residence) && !in_array($country_of_residence, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'country_of_residence', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param \MarketPay\Model\KycDocumentDetails $id_card_document id_card_document
     *
     * @return $this
     */
     ...
     *
     * @param \MarketPay\Model\KycDocumentDetails $power_of_attorney power_of_attorney
     *
     * @return $this
     */
