...
/**
 * AddonPaymentsPayInsResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddonPaymentsPayInsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddonPaymentsPayInsResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'language' => 'string',
        'provider' => '\Swagger\Client\Model\PaymentAddonPaymentsData',
        'id' => 'string',
        'creation_date' => 'int',
        'tag' => 'string'
    ];
     ...
     * Gets provider
     *
     * @return \Swagger\Client\Model\PaymentAddonPaymentsData
     */
     ...
     * Sets provider
     *
     * @param \Swagger\Client\Model\PaymentAddonPaymentsData $provider provider
     *
     * @return $this
     */
