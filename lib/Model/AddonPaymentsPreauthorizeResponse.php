...
/**
 * AddonPaymentsPreauthorizeResponse Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddonPaymentsPreauthorizeResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddonPaymentsPreauthorizeResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'pay_in_id' => 'string',
        'language' => 'string',
        'provider' => '\Swagger\Client\Model\PreauthorizationAddonPaymentsData',
        'id' => 'string',
        'creation_date' => 'int',
        'tag' => 'string'
    ];
     ...
     * Gets provider
     *
     * @return \Swagger\Client\Model\PreauthorizationAddonPaymentsData
     */
     ...
     * Sets provider
     *
     * @param \Swagger\Client\Model\PreauthorizationAddonPaymentsData $provider provider
     *
     * @return $this
     */
