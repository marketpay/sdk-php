...
class AddonPaymentsPreauthorizeResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'pay_in_id' => 'string',
        'language' => 'string',
        'provider' => '\MarketPay\Model\PreauthorizationAddonPaymentsData',
        'id' => 'string',
        'creation_date' => 'int',
        'tag' => 'string'
    ];
     ...
     * Gets provider
     *
     * @return \MarketPay\Model\PreauthorizationAddonPaymentsData
     */
     ...
     * Sets provider
     *
     * @param \MarketPay\Model\PreauthorizationAddonPaymentsData $provider provider
     *
     * @return $this
     */
