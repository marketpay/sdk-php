...
/**
 * KycNaturalUserDataDto Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class KycNaturalUserDataDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'KycNaturalUserDataDto';
     ...
     * Sets first_name
     *
     * @param \MarketPay\Model\PropertyValidationString $first_name The name of the user
     *
     * @return $this
     */
     ...
     * Sets last_name
     *
     * @param \MarketPay\Model\PropertyValidationString $last_name The last name of the user
     *
     * @return $this
     */
     ...
     * Sets address
     *
     * @param \MarketPay\Model\TAddressValidationResult $address The address
     *
     * @return $this
     */
     ...
     * Sets birthday
     *
     * @param \MarketPay\Model\PropertyValidationDateNullable $birthday The date of birth of the user - be careful to set the right timezone (should be UTC) to avoid 00h becoming 23h (and hence interpreted as the day before)
     *
     * @return $this
     */
     ...
     * Sets nationality
     *
     * @param \MarketPay\Model\PropertyValidationCountry $nationality The user’s nationality. ISO 3166-1 alpha-2 format is expected
     *
     * @return $this
     */
     ...
     *
     * @param \MarketPay\Model\PropertyValidationCountry $country_of_residence The user’s country of residence. ISO 3166-1 alpha-2 format is expected
     *
     * @return $this
     */
     ...
     * Sets occupation
     *
     * @param \MarketPay\Model\PropertyValidationString $occupation User’s occupation, ie. Work
     *
     * @return $this
     */
     ...
     *
     * @param \MarketPay\Model\TKycFileDetails $id_card_document Identity card file reference
     *
     * @return $this
     */
