 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ShipmentResponse implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['status_pick_up'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status_pick_up', must be one of #{allowed_values}.";
        }

        $allowed_values = ["Unknown", "Ready", "Delivered"];
        if (!in_array($this->container['status_delivery'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status_delivery', must be one of #{allowed_values}.";
        }
